    ...
    <footer className="footer">
      <div className="footerBox">
        ...
        <div className="boxContact">
          <a href="tel:190012345678" className="contactItem fntPRegular group">
            <img src="img/bt-phone.png" width="57px" height="57px" alt="" /> (+84) 1900 1234 5678
          </a>
          <a href="mailto:hotro@skinrosemary.vn" className="contactItem fntPRegular group">
          ...
          <a
            ...
            className="contactItem fntPRegular group">
